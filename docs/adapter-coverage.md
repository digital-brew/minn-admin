...
| fluent-smtp | Y | Y | Y | Y | — | Y | Y | Y | · | Y | 2026-07-17 | Status + chart + tabs; search + delete; **sections detail** (pill, sandboxed HTML body, provider-reply peek); **settings tab** (default/fallback connection, logging, retention, simulation via their Settings model; connection wizard = **L**) |
