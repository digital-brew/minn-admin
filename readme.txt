...
* **Plugin adapters** — Gravity Forms (readable entries with real field labels, ←/→ between entries, plus a Forms view with activate/deactivate), Gravity SMTP (HTML email preview and resend), Simple History / WP Activity Log / Activity Log / Stream (audit logs), Redirection / Safe Redirect Manager / Simple 301 Redirects (create, search, edit redirects), ACF and SEO views built in, plus one-filter APIs for other plugins (views, editor panels, traffic data, block-inspector forms).
